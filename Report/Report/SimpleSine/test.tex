...
Which means it will take $\frac{\num{1898733}}{\SI{600}{\mega\hertz}} = {\SI{3.16}{\milli\second}}$ so the Hilbert transformation should not take more time than it has at its disposal.\fxnote{Better explanation needed}
