...
public:
	...
	virtual fract16 hilbert();
	void sineGenerator(fract16 input);
...
protected:
	short writeSignal(complex_fract16 buffer[], char *name);
	short writeSignal_fr16(fract16 buffer[], char *name);
